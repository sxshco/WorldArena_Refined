...
Quick start:
- install dependencies and prepare model/data paths with `embodied_task/Readme.md`
- review local path placeholders in `embodied_task/policy_conf`

## 🚀 Public Repo Notes

This public copy has been sanitized for open-source release:
- local absolute paths, private outputs, caches, and repository history were removed
- runtime config now uses repo-relative placeholders where possible
- generated data, checkpoints, caches, and temporary outputs are ignored by `.gitignore`
