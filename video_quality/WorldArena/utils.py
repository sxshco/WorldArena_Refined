...
# Shared cache root used by multiple metric modules.
# Prefer explicit env override; fallback to a repo-local cache directory.
CACHE_DIR = os.environ.get(
    "WORLD_ARENA_CACHE_DIR",
    str(Path(PROJECT_ROOT).resolve().parents[1] / ".cache" / "worldarena"),
)
